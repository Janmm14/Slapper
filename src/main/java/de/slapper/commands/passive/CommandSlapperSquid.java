...
import io.gomint.entity.passive.EntitySquid;

import java.util.Map;

@Name("slapper squid")
@Description("Spawn ein EntitySquid")
@Overload( {
...
public class CommandSlapperSquid extends Command {

    private EntityTypes type = EntityTypes.SQUID;
