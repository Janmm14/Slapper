...
import io.gomint.entity.passive.EntityChicken;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

@Name("slapper chicken")
@Description("Spawn ein EntityChicken")
@Overload( {
...
public class CommandSlapperChicken extends Command {

    private EntityTypes type = EntityTypes.CHICKEN;
