...
import io.gomint.entity.passive.EntityLama;

import java.util.Map;

@Name("slapper lama")
@Description("Spawn ein EntityLama")
@Overload( {
...
public class CommandSlapperLama extends Command {

    private EntityTypes type = EntityTypes.LAMA;
