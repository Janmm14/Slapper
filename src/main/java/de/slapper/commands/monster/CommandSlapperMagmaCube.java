...
import io.gomint.entity.monster.EntityMagmaCube;

import java.util.Map;

@Name("slapper magmacube")
@Description("Spawn ein EntityMagmaCube")
@Overload( {
...
public class CommandSlapperMagmaCube extends Command {

    private EntityTypes type = EntityTypes.MAGMA_CUBE;
