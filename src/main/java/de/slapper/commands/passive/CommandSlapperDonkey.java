...
import io.gomint.entity.passive.EntityDonkey;

import java.util.Map;

@Name("slapper donkey")
@Description("Spawn ein EntityDonkey")
@Overload( {
...
public class CommandSlapperDonkey extends Command {

    private EntityTypes type = EntityTypes.DONKEY;
