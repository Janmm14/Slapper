...
@Name("slapper elderguardian")
@Description("Spawn ein EntityElderGuardian")
@Overload( {
...
public class CommandSlapperElderGuardian extends Command {

    private EntityTypes type = EntityTypes.ELDER_GUARDIAN;
