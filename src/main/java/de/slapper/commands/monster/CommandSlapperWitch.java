...
import io.gomint.entity.monster.EntityWitch;

import java.util.Map;

@Name("slapper witch")
@Description("Spawn ein EntityWitch")
@Overload( {
...
public class CommandSlapperWitch extends Command {

    private EntityTypes type = EntityTypes.WITCH;
