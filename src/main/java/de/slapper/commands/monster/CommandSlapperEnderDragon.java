...
import io.gomint.entity.monster.EntityEnderDragon;

import java.util.Map;

@Name("slapper enderdragon")
@Description("Spawn ein EntityEnderDragon")
@Overload( {
...
public class CommandSlapperEnderDragon extends Command {

    private EntityTypes type = EntityTypes.ENDER_DRAGON;
