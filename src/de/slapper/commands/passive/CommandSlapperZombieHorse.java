...
import io.gomint.entity.passive.EntityZombieHorse;

import java.util.Map;

@Name("slapper zombiehorse")
@Description("Spawn ein EntityZombieHorse")
@Overload( {
...
public class CommandSlapperZombieHorse extends Command {

    private EntityTypes type = EntityTypes.ZOMBIE_HOSE;
