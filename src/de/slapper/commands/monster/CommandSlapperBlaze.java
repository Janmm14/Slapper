...
import io.gomint.entity.monster.EntityBlaze;

import java.util.Map;

@Name("slapper blaze")
@Description("Spawn ein EntityBlaze")
@Overload( {
...
public class CommandSlapperBlaze extends Command {

    private EntityTypes type = EntityTypes.BLAZE;
