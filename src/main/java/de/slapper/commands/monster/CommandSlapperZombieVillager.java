...
import io.gomint.entity.monster.EntityZombieVillager;
import io.gomint.entity.passive.EntityVillager;

import java.util.Map;

@Name("slapper zombievillager")
@Description("Spawn ein EntityZombieVillager")
@Overload( {
...
public class CommandSlapperZombieVillager extends Command {

    private EntityTypes type = EntityTypes.ZOMBIE_VILLAGER;
