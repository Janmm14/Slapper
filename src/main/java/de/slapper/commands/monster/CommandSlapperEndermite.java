...
import io.gomint.entity.monster.EntityEndermite;

import java.util.Map;

@Name("slapper endermite")
@Description("Spawn ein EntityEndermite")
@Overload( {
...
public class CommandSlapperEndermite extends Command {

    private EntityTypes type = EntityTypes.ENDERMITE;
