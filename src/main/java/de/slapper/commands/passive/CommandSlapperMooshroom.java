...
import io.gomint.entity.passive.EntityMooshroom;

import java.util.Map;

@Name("slapper mooshroom")
@Description("Spawn ein EntityMooshroom")
@Overload( {
...
public class CommandSlapperMooshroom extends Command {

    private EntityTypes type = EntityTypes.MOOSHROOM;
