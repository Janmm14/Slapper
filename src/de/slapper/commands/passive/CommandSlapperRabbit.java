...
import io.gomint.entity.passive.EntityRabbit;

import java.util.Map;

@Name("slapper rabbit")
@Description("Spawn ein EntityRabbit")
@Overload( {
...
public class CommandSlapperRabbit extends Command {

    private EntityTypes type = EntityTypes.RABBIT;
