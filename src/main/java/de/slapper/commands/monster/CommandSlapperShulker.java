...
import io.gomint.entity.monster.EntityShulker;

import java.util.Map;

@Name("slapper shulker")
@Description("Spawn ein EntityShulker")
@Overload( {
...
public class CommandSlapperShulker extends Command {

    private EntityTypes type = EntityTypes.SHULKER;
