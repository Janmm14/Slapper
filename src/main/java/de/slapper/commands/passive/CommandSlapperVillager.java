...
@Name("slapper villager")
@Description("Spawn ein EntityVillager")
@Overload( {
...
public class CommandSlapperVillager extends Command {

    private EntityTypes type = EntityTypes.VILLAGER;
