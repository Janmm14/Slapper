...
import io.gomint.entity.passive.EntityWolf;

import java.util.Map;

@Name("slapper wolf")
@Description("Spawn ein EntityWolf")
@Overload( {
...
public class CommandSlapperWolf extends Command {

    private EntityTypes type = EntityTypes.WOLF;
