...
import io.gomint.entity.monster.EntityWither;

import java.util.Map;

@Name("slapper wither")
@Description("Spawn ein EntityWither")
@Overload( {
...
public class CommandSlapperWither extends Command {

    private EntityTypes type = EntityTypes.WITHER;
