...
import io.gomint.entity.monster.EntityGhast;

import java.util.Map;

@Name("slapper ghast")
@Description("Spawn ein EntityGhast")
@Overload( {
...
public class CommandSlapperGhast extends Command {

    private EntityTypes type = EntityTypes.GHAST;
