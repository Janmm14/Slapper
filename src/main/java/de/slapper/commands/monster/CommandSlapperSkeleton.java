...
@Name("slapper skeleton")
@Description("Spawn ein EntitySkeleton")
@Overload( {
...
public class CommandSlapperSkeleton extends Command {

    private EntityTypes type = EntityTypes.SKELETON;
