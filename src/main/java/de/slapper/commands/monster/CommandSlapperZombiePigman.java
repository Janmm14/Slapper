...
import io.gomint.entity.monster.EntityZombiePigman;

import java.util.Map;

@Name("slapper zombiepigman")
@Description("Spawn ein EntityZombiePigman")
@Overload( {
...
public class CommandSlapperZombiePigman extends Command {

    private EntityTypes type = EntityTypes.ZOMBIE_PIGMAN;
