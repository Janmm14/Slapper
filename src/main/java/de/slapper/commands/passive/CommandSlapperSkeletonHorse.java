...
import io.gomint.entity.passive.EntitySkeletonHorse;

import java.util.Map;

@Name("slapper skeletonhorse")
@Description("Spawn ein EntitySkeletonHorse")
@Overload( {
...
public class CommandSlapperSkeletonHorse extends Command {

    private EntityTypes type = EntityTypes.SKELETON_HORSE;
