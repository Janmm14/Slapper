...
import io.gomint.entity.monster.EntityPolarBear;

import java.util.Map;

@Name("slapper polarbear")
@Description("Spawn ein EntityPolarBear")
@Overload( {
...
public class CommandSlapperPolarBear extends Command {

    private EntityTypes type = EntityTypes.POLAR_BEAR;
