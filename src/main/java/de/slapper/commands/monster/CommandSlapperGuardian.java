...
import io.gomint.entity.monster.EntityGuardian;

import java.util.Map;

@Name("slapper guardian")
@Description("Spawn ein EntityGuardian")
@Overload( {
...
public class CommandSlapperGuardian extends Command {

    private EntityTypes type = EntityTypes.GUARDIAN;
