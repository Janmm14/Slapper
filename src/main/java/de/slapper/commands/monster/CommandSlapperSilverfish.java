...
import io.gomint.entity.monster.EntitySilverfish;

import java.util.Map;

@Name("slapper silverfish")
@Description("Spawn ein EntitySilverfish")
@Overload( {
...
public class CommandSlapperSilverfish extends Command {

    private EntityTypes type = EntityTypes.SILVERFISH;
