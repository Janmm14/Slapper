...
import io.gomint.entity.passive.EntityHorse;

import java.util.Map;

@Name("slapper horse")
@Description("Spawn ein EntityHorse")
@Overload( {
...
public class CommandSlapperHorse extends Command {

    private EntityTypes type = EntityTypes.HORSE;
