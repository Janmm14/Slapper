...
import io.gomint.entity.monster.EntityCaveSpider;

import java.util.Map;

@Name("slapper cavespider")
@Description("Spawn ein EntityCaveSpider")
@Overload( {
...
public class CommandSlapperCaveSpider extends Command {

    private EntityTypes type = EntityTypes.CAVE_SPIDER;
