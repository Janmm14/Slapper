...
import io.gomint.entity.passive.EntityMule;

import java.util.Map;

@Name("slapper mule")
@Description("Spawn ein EntityMule")
@Overload( {
...
public class CommandSlapperMule extends Command {

    private EntityTypes type = EntityTypes.MULE;
